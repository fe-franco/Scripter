...
namespace eval ttk::theme::style {

    variable version 1.3
    package provide ttk::theme::style $version
    variable colors
    array set colors {
        -fg             "#ffffff"
        -bg             "#ffffff"
    ...
    proc LoadImages {imgdir} {
        variable I
        foreach file [glob -directory $imgdir {*}[list *.gif *.png]] {
            set img [file tail [file rootname $file]]
            set I($img) [image create photo -file $file]
        }
    }
    LoadImages [file join [file dirname [info script]] assets]

    # Settings
    ttk::style theme create style -parent default -settings {
        ttk::style configure . \
    ...
    ttk::style map TCombobox -selectforeground [list \
        ...
        {readonly disabled} $colors(-selectfg) \
    ]


ttk::style element create Combobox.border image $I(box-basic) \
    -border 5 -padding {8}
...
ttk::style element create Combobox.dropdown.border image $I(box-basic) \
    -border 5 -padding {8}

ttk::style element create Combobox.dropdown.field \
    image [list $I(box-basic) \
    {readonly disabled} $I(rect-basic) \
    {readonly pressed} $I(rect-basic) \
    {readonly focus hover} $I(button-hover) \
